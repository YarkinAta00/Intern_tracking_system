...
export default {
    ...
    methods: {
        register() {
            axios.post(this.baseURL+`InternshipTracker/Register?firstName=${this.firstName}&lastName=${this.lastName}&Email=${this.email}&Password=${this.password}&address=${this.address}&phoneNumber=${this.phoneNumber}&gender=${this.gender}`)
                .then(response => {
...
<template>
    ...
    <div id="main-container"
        ...
        <form class="inputs form-controll">
            <div class="row ">
                <div class="col">
                    <Textfield label="Name" type="email" id="NameInput" v-model="firstName" class="form-control mt-1" />
                    {{ firstName }}
                    <br>
                    <Textfield label="Surname" type="text" id="SurnameInput" v-model="lastName"
                        class="form-control mt-1" />
                    {{ lastName }}
                    <br>
                    <Textfield label="Address" type="text" id="AddressInput" v-model="address"
                        class="form-control mt-1" />
                    {{ address }}
                    <br>
                ...
                <div class="col">
                    ...
                    <Textfield label="Password" type="password" id="passwordInput" v-model="password"
                        class="form-control mt-1" aria-labelledby="passwordHelpBlock" />
                    {{ password }}
                    <br>
                    <Textfield label="Phone Number" type="tel" id="PhoneInput" v-model="phoneNumber"
                        class="form-control mt-1"/>
                    {{ phoneNumber }}
                </div>
            </div>
