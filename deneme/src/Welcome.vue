...
export default {
  ...
  methods: {
    login() {
      //debugger
      /*
      if (this.userInfo.name == "yarkinata@gmail.com" && this.userInfo.password == "123") {
        alert("Welcome")
      }
      else {
...
<template>
  <div id="main-container"
    class="container-sm d-flex flex-column align-items-center justify-content-center border border-4 border-dark rounded mt-3 p-4">
    <div>
    ...
    <form class="inputs">
      <!--
         ...
         v-model Sadece text inputunda değil bütün input tiplerinde çalışır (radio button, checkbox and etc.)
              -->
        <!--
//Debug yapmayı dene (inputları alamıyor methodun içinde null oluyolar)
//CV yükleme sistemi 
//Başvuru sistemi
//Gün sayacı ( Stajyerlerin kaç günü kaldı) 
//Admin paneli
          -->
      <Textfield label="Email" type="email" id="emailInput" v-model="userInfo.name" class="form-control" />
